  ...
  return (
    <section className="py-16 md:py-20 text-gray-100 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        {/* Highlighted Admission Link & PDF Section */}
        <motion.div
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-white">
                  Against CAP Admission Schedule & Portal
                </h3>
              </div>
            </div>

            {/* Action Buttons: Admission Link + PDF View/Download */}
            <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-start md:justify-end">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-yellow-400/50 bg-[#132347] px-4 py-2.5 text-xs sm:text-sm font-semibold text-yellow-300 hover:bg-yellow-400 hover:text-[#132347] transition-all duration-300 shadow-md"
              >
